...
var DirMapComponent = /** @class */ (function () {
    ...
    DirMapComponent.prototype.myMap = function (data) {
        ...
        this.url = 'https://www.google.com/maps/dir/?api=1&origin=' + this.currentHospData.lat + ',' + this.currentHospData.lng + '&origin_place_id=' + this.currentHospData.placeId + '&destination=' + this.lat + ',' + this.lng + '&travelmode=driving&key=AIzaSyDDNnPuIzO1BpY53h1wGfcTb2ERQOCDJfw';
...
var GetMapDataService = /** @class */ (function () {
    ...
    // 10.20.6.118
    // tslint:disable-next-line:no-inferrable-types
    GetMapDataService.ip = '35.154.168.17';
    // tslint:disable-next-line:no-inferrable-types
